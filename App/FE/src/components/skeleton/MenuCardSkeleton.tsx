...
export function MenuCardSkeleton() {
  return (
    <div className="relative flex flex-col bg-white dark:bg-neutral-900 rounded-xl border border-neutral-100 overflow-hidden shadow-sm">
      ...
      <div className="flex flex-col p-3.5 space-y-3">
        ...
        <div className="space-y-2">
          <div className="h-4 w-3/4 rounded-lg" />
        </div>
