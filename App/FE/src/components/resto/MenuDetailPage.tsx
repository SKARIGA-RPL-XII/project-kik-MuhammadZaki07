...
export default function MenuDetailPage() {
  ...
  return (
    <div className="min-h-screen pb-40">
      ...
      >
        <div className="bg-white dark:bg-neutral-900 rounded-t-xl p-5">
          <div className="flex justify-between items-start mb-4">
            <div className="flex-1">
              ...
              <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-300 mt-2">
                {menu.name}
              </h1>
            </div>
            ...
            <div className="text-right">
              ...
              <p className="text-xl font-black text-red-600 dark:text-neutral-300">
                Rp {priceData.discountedPrice.toLocaleString("id-ID")}
              </p>
            </div>
          </div>

          <p className="text-neutral-500  dark:text-neutral-300 text-sm mb-8 leading-relaxed">
            {menu.description}
          </p>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-5 bg-white/90 dark:bg-neutral-900/50 backdrop-blur-md border-t">
