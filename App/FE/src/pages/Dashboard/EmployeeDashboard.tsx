        ...
        <div className="col-span-12 lg:col-span-5">
          <Card
            className={`overflow-hidden border-2 shadow-none transition-all ${
              !hasSchedule || isHoliday ? "" : attendance ? " " : ""
              ...
              {!hasSchedule || isHoliday ? (
                <div className="space-y-4">
                  <p className="text-sm font-normal text-neutral-500">
                    You have no work schedule today. Enjoy your rest!
                  </p>
                  <Badge
                    variant={"outline"}
                    className="flex items-center gap-2 text-[11px] text-blue-600 w-fit px-3 py-1 rounded-full font-bold"
                  >
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-sm text-neutral-500">Clock In Time</p>
                ...
                <div className="space-y-4">
                  ...
                  <Link to={"/attendance"}>
                    <Button className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-6 shadow-none transition-transform active:scale-95">
                      Clock In Now <AlertCircle className="ml-2 h-5 w-5" />
                    </Button>
                  </Link>
                </div>
              )}
            ...
            <CardContent>
              ...
              {!!summary?.alpha && summary.alpha >= 2 && (
                <p className="mt-2 text-[10px] font-bold text-red-500 flex items-center gap-1 animate-pulse">
                  <AlertTriangle className="h-3 w-3" /> Suspension limit: 3
                  times Absent
                </p>
              )}
            </CardContent>
