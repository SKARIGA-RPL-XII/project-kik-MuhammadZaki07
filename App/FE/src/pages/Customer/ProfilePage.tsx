      ...
      <div className="max-w-2xl mx-auto px-5 py-8">
        ...
        >
          <TabsList className="flex bg-neutral-100/80 p-1 rounded-xl mb-8 h-auto">
            <TabsTrigger 
              value="profile" 
              className="flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-lg text-sm font-medium transition-all data-[state=active]:bg-white data-[state=active]:text-red-600 data-[state=active]:shadow-sm text-neutral-500"
            >
