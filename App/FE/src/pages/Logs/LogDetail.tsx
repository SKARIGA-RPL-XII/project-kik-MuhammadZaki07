...
const LogDetailPage = () => {
  ...
  const TerminalWindow = ({
    ...
    <div className="flex flex-col h-full rounded-2xl overflow-hidden border bg-white dark:bg-[#121212]">
      ...
      <div className="p-6 overflow-auto h-[450px] font-mono text-[13px] leading-relaxed bg-neutral-900 dark:bg-neutral-950">
        <pre
          className={
            variant === "red"
        ...
        >
          {data ? JSON.stringify(data, null, 2) : `// Tidak ada data ${title}`}
        </pre>
      </div>
    </div>
  );
